            ...
            {Object.entries(combinations).map(([variant, combos], index) => {
                return (
                    <div key={`${variant}-${index}`} className="contents">
                        ...
                        <div
                            className="flex flex-wrap items-center justify-around gap-2 p-4"
...
const ComponentTitle = ({ children }: { children: ReactNode }) => {
    return (
        <>
            <h2 className="pb-4 text-2xl font-semibold">{children}</h2>
        </>
    );
};
...
const VariantTitle = ({ children }: { children: ReactNode }) => {
    return (
        <>
            <h3 className="py-1 pt-4 text-base font-semibold">{children}</h3>
        </>
    );
};
